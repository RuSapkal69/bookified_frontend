      ...
      <div className="search-section animate-on-scroll">
        <div className="search-container">
          ...
          >
            <Dropdown.Item
              onClick={() => {
                handleSearchByType("name")
                setSearchType("Book Name")
              }}
            >
              Book Name
            </Dropdown.Item>
          ...
          />
          <button className="search-button" onClick={() => handleSearchByType("name")} disabled={isLoading}>
            {isLoading ? "Searching..." : <i className="fa fa-search"></i>}
          </button>
        </div>
      </div>
